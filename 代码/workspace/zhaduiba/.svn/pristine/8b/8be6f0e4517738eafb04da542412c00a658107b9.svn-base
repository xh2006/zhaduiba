    ...
    <div id="main_center">
    	<div id="main_center_left">
        	...
        	<div id="main_left_content">
            	<s:iterator value="duierInfoList" var="duierInfo">
        			<ul class="duier_content">
                	<li class="content_title"><s:property value="#duierInfo.duierInfoName" /></li>
                    <li class="content_line"></li>
                    <li class="content_duier">
                    <s:if test="%{null!=#duierInfo.duierInfoActivityIntroduction && #duierInfo.duierInfoActivityIntroduction.length()>150}">
                    	<s:property value="%{#duierInfo.duierInfoActivityIntroduction.substring(0, 150)}" />...
                    </s:if>
                    <s:else>
                    	<s:property value="%{#duierInfo.duierInfoActivityIntroduction}" />
                    </s:else>
                    </li>
                </ul>
        		</s:iterator>
